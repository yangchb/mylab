...
parse(char *buf, char **argv) {
  ...
  100a81:	c7 04 24 b0 36 10 00 	movl   $0x1036b0,(%esp)
  100a88:	e8 a2 26 00 00       	call   10312f <strchr>
  ...
  100aaa:	00 
  100aab:	c7 04 24 b5 36 10 00 	movl   $0x1036b5,(%esp)
  ...
  100aee:	c7 04 24 b0 36 10 00 	movl   $0x1036b0,(%esp)
  100af5:	e8 35 26 00 00       	call   10312f <strchr>
...
runcmd(char *buf, struct trapframe *tf) {
  ...
  100b5a:	e8 31 25 00 00       	call   103090 <strcmp>
  ...
  100ba8:	c7 04 24 d3 36 10 00 	movl   $0x1036d3,(%esp)
...
kmonitor(struct trapframe *tf) {
  ...
  100bc1:	c7 04 24 ec 36 10 00 	movl   $0x1036ec,(%esp)
  100bc8:	e8 45 f7 ff ff       	call   100312 <cprintf>
    cprintf("Type 'help' for a list of commands.\n");
  100bcd:	c7 04 24 14 37 10 00 	movl   $0x103714,(%esp)
  ...
  100be5:	e8 d3 0d 00 00       	call   1019bd <print_trapframe>
    }

    char *buf;
    while (1) {
        if ((buf = readline("K> ")) != NULL) {
  100bea:	c7 04 24 39 37 10 00 	movl   $0x103739,(%esp)
...
mon_help(int argc, char **argv, struct trapframe *tf) {
  ...
  100c59:	c7 04 24 3d 37 10 00 	movl   $0x10373d,(%esp)
...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  100ccb:	c7 04 24 46 37 10 00 	movl   $0x103746,(%esp)
  ...
  100ce4:	e8 f6 f5 ff ff       	call   1002df <vcprintf>
    cprintf("\n");
  100ce9:	c7 04 24 62 37 10 00 	movl   $0x103762,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  100d22:	c7 04 24 64 37 10 00 	movl   $0x103764,(%esp)
  ...
  100d3b:	e8 9f f5 ff ff       	call   1002df <vcprintf>
    cprintf("\n");
  100d40:	c7 04 24 62 37 10 00 	movl   $0x103762,(%esp)
...
outb(uint16_t port, uint8_t data) {
  ...
  100da1:	c7 04 24 82 37 10 00 	movl   $0x103782,(%esp)
...
cga_putc(int c) {
  ...
  10118e:	e8 9a 21 00 00       	call   10332d <memmove>
...
inb(uint16_t port) {
  ...
  101512:	75 1f                	jne    101533 <kbd_proc_data+0x184>
        cprintf("Rebooting!\n");
  101514:	c7 04 24 9d 37 10 00 	movl   $0x10379d,(%esp)
...
cons_init(void) {
  ...
  101583:	c7 04 24 a9 37 10 00 	movl   $0x1037a9,(%esp)
...
idt_init(void) {
  ...
  101813:	e9 c3 00 00 00       	jmp    1018db <idt_init+0xdc>
	{
	SETGATE(idt[i], 0, GD_KTEXT, __vectors[i], DPL_KERNEL);
  101818:	8b 45 fc             	mov    -0x4(%ebp),%eax
  10181b:	8b 04 85 e0 e5 10 00 	mov    0x10e5e0(,%eax,4),%eax
  101822:	89 c2                	mov    %eax,%edx
  101824:	8b 45 fc             	mov    -0x4(%ebp),%eax
  101827:	66 89 14 c5 a0 f0 10 	mov    %dx,0x10f0a0(,%eax,8)
  10182e:	00 
  10182f:	8b 45 fc             	mov    -0x4(%ebp),%eax
  101832:	66 c7 04 c5 a2 f0 10 	movw   $0x8,0x10f0a2(,%eax,8)
  101839:	00 08 00 
  10183c:	8b 45 fc             	mov    -0x4(%ebp),%eax
  10183f:	0f b6 14 c5 a4 f0 10 	movzbl 0x10f0a4(,%eax,8),%edx
  101846:	00 
  101847:	83 e2 e0             	and    $0xffffffe0,%edx
  10184a:	88 14 c5 a4 f0 10 00 	mov    %dl,0x10f0a4(,%eax,8)
  101851:	8b 45 fc             	mov    -0x4(%ebp),%eax
  101854:	0f b6 14 c5 a4 f0 10 	movzbl 0x10f0a4(,%eax,8),%edx
  10185b:	00 
  10185c:	83 e2 1f             	and    $0x1f,%edx
  10185f:	88 14 c5 a4 f0 10 00 	mov    %dl,0x10f0a4(,%eax,8)
  101866:	8b 45 fc             	mov    -0x4(%ebp),%eax
  101869:	0f b6 14 c5 a5 f0 10 	movzbl 0x10f0a5(,%eax,8),%edx
  101870:	00 
  ...
  101888:	00 
  101889:	83 e2 ef             	and    $0xffffffef,%edx
  ...
  10189d:	00 
  10189e:	83 e2 9f             	and    $0xffffff9f,%edx
  ...
  1018b2:	00 
  1018b3:	83 ca 80             	or     $0xffffff80,%edx
  1018b6:	88 14 c5 a5 f0 10 00 	mov    %dl,0x10f0a5(,%eax,8)
  1018bd:	8b 45 fc             	mov    -0x4(%ebp),%eax
  1018c0:	8b 04 85 e0 e5 10 00 	mov    0x10e5e0(,%eax,4),%eax
  1018c7:	c1 e8 10             	shr    $0x10,%eax
  1018ca:	89 c2                	mov    %eax,%edx
  1018cc:	8b 45 fc             	mov    -0x4(%ebp),%eax
  1018cf:	66 89 14 c5 a6 f0 10 	mov    %dx,0x10f0a6(,%eax,8)
  1018d6:	00 
      *     You don't know the meaning of this instruction? just google it! and check the libs/x86.h to know more.
      *     Notice: the argument of lidt is idt_pd. try to find it!
      */
	extern uintptr_t __vectors[];
        int i = 0;
        for(i = 0; i < 256; i++)
  1018d7:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
  1018db:	81 7d fc ff 00 00 00 	cmpl   $0xff,-0x4(%ebp)
  1018e2:	0f 8e 30 ff ff ff    	jle    101818 <idt_init+0x19>
	{
	SETGATE(idt[i], 0, GD_KTEXT, __vectors[i], DPL_KERNEL);
	}
	SETGATE(idt[T_SWITCH_TOK], 0, GD_KTEXT, __vectors[T_SWITCH_TOK], DPL_USER);
  1018e8:	a1 c4 e7 10 00       	mov    0x10e7c4,%eax
  1018ed:	66 a3 68 f4 10 00    	mov    %ax,0x10f468
  1018f3:	66 c7 05 6a f4 10 00 	movw   $0x8,0x10f46a
  1018fa:	08 00 
  1018fc:	0f b6 05 6c f4 10 00 	movzbl 0x10f46c,%eax
  101903:	83 e0 e0             	and    $0xffffffe0,%eax
  101906:	a2 6c f4 10 00       	mov    %al,0x10f46c
  10190b:	0f b6 05 6c f4 10 00 	movzbl 0x10f46c,%eax
  101912:	83 e0 1f             	and    $0x1f,%eax
  101915:	a2 6c f4 10 00       	mov    %al,0x10f46c
  10191a:	0f b6 05 6d f4 10 00 	movzbl 0x10f46d,%eax
  101921:	83 e0 f0             	and    $0xfffffff0,%eax
  101924:	83 c8 0e             	or     $0xe,%eax
  101927:	a2 6d f4 10 00       	mov    %al,0x10f46d
  10192c:	0f b6 05 6d f4 10 00 	movzbl 0x10f46d,%eax
  101933:	83 e0 ef             	and    $0xffffffef,%eax
  101936:	a2 6d f4 10 00       	mov    %al,0x10f46d
  10193b:	0f b6 05 6d f4 10 00 	movzbl 0x10f46d,%eax
  101942:	83 c8 60             	or     $0x60,%eax
  101945:	a2 6d f4 10 00       	mov    %al,0x10f46d
  10194a:	0f b6 05 6d f4 10 00 	movzbl 0x10f46d,%eax
  101951:	83 c8 80             	or     $0xffffff80,%eax
  101954:	a2 6d f4 10 00       	mov    %al,0x10f46d
  101959:	a1 c4 e7 10 00       	mov    0x10e7c4,%eax
  10195e:	c1 e8 10             	shr    $0x10,%eax
  101961:	66 a3 6e f4 10 00    	mov    %ax,0x10f46e
  101967:	c7 45 f8 60 e5 10 00 	movl   $0x10e560,-0x8(%ebp)
    return ebp;
}
...
lidt(struct pseudodesc *pd) {
    asm volatile ("lidt (%0)" :: "r" (pd));
  10196e:	8b 45 f8             	mov    -0x8(%ebp),%eax
  101971:	0f 01 18             	lidtl  (%eax)
	lidt(&idt_pd);
}
  101974:	c9                   	leave  
  101975:	c3                   	ret    
...
trapname(int trapno) {
  ...
  10197c:	83 f8 13             	cmp    $0x13,%eax
  10197f:	77 0c                	ja     10198d <trapname+0x17>
        return excnames[trapno];
  101981:	8b 45 08             	mov    0x8(%ebp),%eax
  101984:	8b 04 85 40 3b 10 00 	mov    0x103b40(,%eax,4),%eax
  10198b:	eb 18                	jmp    1019a5 <trapname+0x2f>
    }
    if (trapno >= IRQ_OFFSET && trapno < IRQ_OFFSET + 16) {
  10198d:	83 7d 08 1f          	cmpl   $0x1f,0x8(%ebp)
  101991:	7e 0d                	jle    1019a0 <trapname+0x2a>
  101993:	83 7d 08 2f          	cmpl   $0x2f,0x8(%ebp)
  101997:	7f 07                	jg     1019a0 <trapname+0x2a>
        return "Hardware Interrupt";
  101999:	b8 ea 37 10 00       	mov    $0x1037ea,%eax
  10199e:	eb 05                	jmp    1019a5 <trapname+0x2f>
    }
    return "(unknown trap)";
  1019a0:	b8 fd 37 10 00       	mov    $0x1037fd,%eax
}
  1019a5:	5d                   	pop    %ebp
  1019a6:	c3                   	ret    

001019a7 <trap_in_kernel>:
...
trap_in_kernel(struct trapframe *tf) {
  ...
  1019ad:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
  1019b1:	66 83 f8 08          	cmp    $0x8,%ax
  1019b5:	0f 94 c0             	sete   %al
  1019b8:	0f b6 c0             	movzbl %al,%eax
}
  1019bb:	5d                   	pop    %ebp
  1019bc:	c3                   	ret    

001019bd <print_trapframe>:
...
print_trapframe(struct trapframe *tf) {
  1019bd:	55                   	push   %ebp
  1019be:	89 e5                	mov    %esp,%ebp
  1019c0:	83 ec 28             	sub    $0x28,%esp
    cprintf("trapframe at %p\n", tf);
  1019c3:	8b 45 08             	mov    0x8(%ebp),%eax
  1019c6:	89 44 24 04          	mov    %eax,0x4(%esp)
  1019ca:	c7 04 24 3e 38 10 00 	movl   $0x10383e,(%esp)
  1019d1:	e8 3c e9 ff ff       	call   100312 <cprintf>
    print_regs(&tf->tf_regs);
  1019d6:	8b 45 08             	mov    0x8(%ebp),%eax
  1019d9:	89 04 24             	mov    %eax,(%esp)
  1019dc:	e8 a1 01 00 00       	call   101b82 <print_regs>
    cprintf("  ds   0x----%04x\n", tf->tf_ds);
  1019e1:	8b 45 08             	mov    0x8(%ebp),%eax
  1019e4:	0f b7 40 2c          	movzwl 0x2c(%eax),%eax
  1019e8:	0f b7 c0             	movzwl %ax,%eax
  1019eb:	89 44 24 04          	mov    %eax,0x4(%esp)
  1019ef:	c7 04 24 4f 38 10 00 	movl   $0x10384f,(%esp)
  1019f6:	e8 17 e9 ff ff       	call   100312 <cprintf>
    cprintf("  es   0x----%04x\n", tf->tf_es);
  1019fb:	8b 45 08             	mov    0x8(%ebp),%eax
  1019fe:	0f b7 40 28          	movzwl 0x28(%eax),%eax
  101a02:	0f b7 c0             	movzwl %ax,%eax
  101a05:	89 44 24 04          	mov    %eax,0x4(%esp)
  101a09:	c7 04 24 62 38 10 00 	movl   $0x103862,(%esp)
  101a10:	e8 fd e8 ff ff       	call   100312 <cprintf>
    cprintf("  fs   0x----%04x\n", tf->tf_fs);
  101a15:	8b 45 08             	mov    0x8(%ebp),%eax
  101a18:	0f b7 40 24          	movzwl 0x24(%eax),%eax
  101a1c:	0f b7 c0             	movzwl %ax,%eax
  101a1f:	89 44 24 04          	mov    %eax,0x4(%esp)
  101a23:	c7 04 24 75 38 10 00 	movl   $0x103875,(%esp)
  101a2a:	e8 e3 e8 ff ff       	call   100312 <cprintf>
    cprintf("  gs   0x----%04x\n", tf->tf_gs);
  101a2f:	8b 45 08             	mov    0x8(%ebp),%eax
  101a32:	0f b7 40 20          	movzwl 0x20(%eax),%eax
  101a36:	0f b7 c0             	movzwl %ax,%eax
  101a39:	89 44 24 04          	mov    %eax,0x4(%esp)
  101a3d:	c7 04 24 88 38 10 00 	movl   $0x103888,(%esp)
  101a44:	e8 c9 e8 ff ff       	call   100312 <cprintf>
    cprintf("  trap 0x%08x %s\n", tf->tf_trapno, trapname(tf->tf_trapno));
  101a49:	8b 45 08             	mov    0x8(%ebp),%eax
  101a4c:	8b 40 30             	mov    0x30(%eax),%eax
  101a4f:	89 04 24             	mov    %eax,(%esp)
  101a52:	e8 1f ff ff ff       	call   101976 <trapname>
  101a57:	8b 55 08             	mov    0x8(%ebp),%edx
  101a5a:	8b 52 30             	mov    0x30(%edx),%edx
  101a5d:	89 44 24 08          	mov    %eax,0x8(%esp)
  101a61:	89 54 24 04          	mov    %edx,0x4(%esp)
  101a65:	c7 04 24 9b 38 10 00 	movl   $0x10389b,(%esp)
  101a6c:	e8 a1 e8 ff ff       	call   100312 <cprintf>
    cprintf("  err  0x%08x\n", tf->tf_err);
  101a71:	8b 45 08             	mov    0x8(%ebp),%eax
  101a74:	8b 40 34             	mov    0x34(%eax),%eax
  101a77:	89 44 24 04          	mov    %eax,0x4(%esp)
  101a7b:	c7 04 24 ad 38 10 00 	movl   $0x1038ad,(%esp)
  101a82:	e8 8b e8 ff ff       	call   100312 <cprintf>
    cprintf("  eip  0x%08x\n", tf->tf_eip);
  101a87:	8b 45 08             	mov    0x8(%ebp),%eax
  101a8a:	8b 40 38             	mov    0x38(%eax),%eax
  101a8d:	89 44 24 04          	mov    %eax,0x4(%esp)
  101a91:	c7 04 24 bc 38 10 00 	movl   $0x1038bc,(%esp)
  101a98:	e8 75 e8 ff ff       	call   100312 <cprintf>
    cprintf("  cs   0x----%04x\n", tf->tf_cs);
  101a9d:	8b 45 08             	mov    0x8(%ebp),%eax
  101aa0:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
  101aa4:	0f b7 c0             	movzwl %ax,%eax
  101aa7:	89 44 24 04          	mov    %eax,0x4(%esp)
  101aab:	c7 04 24 cb 38 10 00 	movl   $0x1038cb,(%esp)
  101ab2:	e8 5b e8 ff ff       	call   100312 <cprintf>
    cprintf("  flag 0x%08x ", tf->tf_eflags);
  101ab7:	8b 45 08             	mov    0x8(%ebp),%eax
  101aba:	8b 40 40             	mov    0x40(%eax),%eax
  101abd:	89 44 24 04          	mov    %eax,0x4(%esp)
  101ac1:	c7 04 24 de 38 10 00 	movl   $0x1038de,(%esp)
  101ac8:	e8 45 e8 ff ff       	call   100312 <cprintf>

    int i, j;
    for (i = 0, j = 1; i < sizeof(IA32flags) / sizeof(IA32flags[0]); i ++, j <<= 1) {
  101acd:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  101ad4:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
  101adb:	eb 3e                	jmp    101b1b <print_trapframe+0x15e>
        if ((tf->tf_eflags & j) && IA32flags[i] != NULL) {
  101add:	8b 45 08             	mov    0x8(%ebp),%eax
  101ae0:	8b 50 40             	mov    0x40(%eax),%edx
  101ae3:	8b 45 f0             	mov    -0x10(%ebp),%eax
  101ae6:	21 d0                	and    %edx,%eax
  101ae8:	85 c0                	test   %eax,%eax
  101aea:	74 28                	je     101b14 <print_trapframe+0x157>
  101aec:	8b 45 f4             	mov    -0xc(%ebp),%eax
  101aef:	8b 04 85 80 e5 10 00 	mov    0x10e580(,%eax,4),%eax
  101af6:	85 c0                	test   %eax,%eax
  101af8:	74 1a                	je     101b14 <print_trapframe+0x157>
            cprintf("%s,", IA32flags[i]);
  101afa:	8b 45 f4             	mov    -0xc(%ebp),%eax
  101afd:	8b 04 85 80 e5 10 00 	mov    0x10e580(,%eax,4),%eax
  101b04:	89 44 24 04          	mov    %eax,0x4(%esp)
  101b08:	c7 04 24 ed 38 10 00 	movl   $0x1038ed,(%esp)
  101b0f:	e8 fe e7 ff ff       	call   100312 <cprintf>
    cprintf("  eip  0x%08x\n", tf->tf_eip);
    cprintf("  cs   0x----%04x\n", tf->tf_cs);
    cprintf("  flag 0x%08x ", tf->tf_eflags);
  ...
  101b35:	c7 04 24 f1 38 10 00 	movl   $0x1038f1,(%esp)
  101b3c:	e8 d1 e7 ff ff       	call   100312 <cprintf>

    if (!trap_in_kernel(tf)) {
  101b41:	8b 45 08             	mov    0x8(%ebp),%eax
  101b44:	89 04 24             	mov    %eax,(%esp)
  101b47:	e8 5b fe ff ff       	call   1019a7 <trap_in_kernel>
  101b4c:	85 c0                	test   %eax,%eax
  101b4e:	75 30                	jne    101b80 <print_trapframe+0x1c3>
        cprintf("  esp  0x%08x\n", tf->tf_esp);
  101b50:	8b 45 08             	mov    0x8(%ebp),%eax
  101b53:	8b 40 44             	mov    0x44(%eax),%eax
  101b56:	89 44 24 04          	mov    %eax,0x4(%esp)
  101b5a:	c7 04 24 fa 38 10 00 	movl   $0x1038fa,(%esp)
  101b61:	e8 ac e7 ff ff       	call   100312 <cprintf>
        cprintf("  ss   0x----%04x\n", tf->tf_ss);
  101b66:	8b 45 08             	mov    0x8(%ebp),%eax
  101b69:	0f b7 40 48          	movzwl 0x48(%eax),%eax
  101b6d:	0f b7 c0             	movzwl %ax,%eax
  101b70:	89 44 24 04          	mov    %eax,0x4(%esp)
  101b74:	c7 04 24 09 39 10 00 	movl   $0x103909,(%esp)
...
print_regs(struct pushregs *regs) {
  ...
  101b85:	83 ec 18             	sub    $0x18,%esp
    cprintf("  edi  0x%08x\n", regs->reg_edi);
  101b88:	8b 45 08             	mov    0x8(%ebp),%eax
  101b8b:	8b 00                	mov    (%eax),%eax
  101b8d:	89 44 24 04          	mov    %eax,0x4(%esp)
  101b91:	c7 04 24 1c 39 10 00 	movl   $0x10391c,(%esp)
  101b98:	e8 75 e7 ff ff       	call   100312 <cprintf>
    cprintf("  esi  0x%08x\n", regs->reg_esi);
  101b9d:	8b 45 08             	mov    0x8(%ebp),%eax
  101ba0:	8b 40 04             	mov    0x4(%eax),%eax
  101ba3:	89 44 24 04          	mov    %eax,0x4(%esp)
  101ba7:	c7 04 24 2b 39 10 00 	movl   $0x10392b,(%esp)
  101bae:	e8 5f e7 ff ff       	call   100312 <cprintf>
    cprintf("  ebp  0x%08x\n", regs->reg_ebp);
  101bb3:	8b 45 08             	mov    0x8(%ebp),%eax
  101bb6:	8b 40 08             	mov    0x8(%eax),%eax
  101bb9:	89 44 24 04          	mov    %eax,0x4(%esp)
  101bbd:	c7 04 24 3a 39 10 00 	movl   $0x10393a,(%esp)
  ...
  101bd3:	c7 04 24 49 39 10 00 	movl   $0x103949,(%esp)
  101bda:	e8 33 e7 ff ff       	call   100312 <cprintf>
    cprintf("  ebx  0x%08x\n", regs->reg_ebx);
  101bdf:	8b 45 08             	mov    0x8(%ebp),%eax
  101be2:	8b 40 10             	mov    0x10(%eax),%eax
  101be5:	89 44 24 04          	mov    %eax,0x4(%esp)
  101be9:	c7 04 24 58 39 10 00 	movl   $0x103958,(%esp)
  101bf0:	e8 1d e7 ff ff       	call   100312 <cprintf>
    cprintf("  edx  0x%08x\n", regs->reg_edx);
  101bf5:	8b 45 08             	mov    0x8(%ebp),%eax
  101bf8:	8b 40 14             	mov    0x14(%eax),%eax
  101bfb:	89 44 24 04          	mov    %eax,0x4(%esp)
  101bff:	c7 04 24 67 39 10 00 	movl   $0x103967,(%esp)
  101c06:	e8 07 e7 ff ff       	call   100312 <cprintf>
    cprintf("  ecx  0x%08x\n", regs->reg_ecx);
  101c0b:	8b 45 08             	mov    0x8(%ebp),%eax
  101c0e:	8b 40 18             	mov    0x18(%eax),%eax
  101c11:	89 44 24 04          	mov    %eax,0x4(%esp)
  101c15:	c7 04 24 76 39 10 00 	movl   $0x103976,(%esp)
  101c1c:	e8 f1 e6 ff ff       	call   100312 <cprintf>
    cprintf("  eax  0x%08x\n", regs->reg_eax);
  101c21:	8b 45 08             	mov    0x8(%ebp),%eax
  101c24:	8b 40 1c             	mov    0x1c(%eax),%eax
  101c27:	89 44 24 04          	mov    %eax,0x4(%esp)
  101c2b:	c7 04 24 85 39 10 00 	movl   $0x103985,(%esp)
  101c32:	e8 db e6 ff ff       	call   100312 <cprintf>
}
  101c37:	c9                   	leave  
  101c38:	c3                   	ret    
...
trap_dispatch(struct trapframe *tf) {
  ...
  101c4d:	0f 83 04 01 00 00    	jae    101d57 <trap_dispatch+0x11e>
  101c53:	83 f8 21             	cmp    $0x21,%eax
  101c56:	0f 84 81 00 00 00    	je     101cdd <trap_dispatch+0xa4>
  101c5c:	83 f8 24             	cmp    $0x24,%eax
  101c5f:	74 56                	je     101cb7 <trap_dispatch+0x7e>
  101c61:	83 f8 20             	cmp    $0x20,%eax
  101c64:	74 16                	je     101c7c <trap_dispatch+0x43>
  101c66:	e9 b4 00 00 00       	jmp    101d1f <trap_dispatch+0xe6>
  101c6b:	83 e8 78             	sub    $0x78,%eax
  101c6e:	83 f8 01             	cmp    $0x1,%eax
  101c71:	0f 87 a8 00 00 00    	ja     101d1f <trap_dispatch+0xe6>
  101c77:	e9 87 00 00 00       	jmp    101d03 <trap_dispatch+0xca>
    case IRQ_OFFSET + IRQ_TIMER:
	ticks++;
  101c7c:	a1 08 f9 10 00       	mov    0x10f908,%eax
  101c81:	83 c0 01             	add    $0x1,%eax
  101c84:	a3 08 f9 10 00       	mov    %eax,0x10f908
	if(ticks%TICK_NUM == 0){
  101c89:	8b 0d 08 f9 10 00    	mov    0x10f908,%ecx
  101c8f:	ba 1f 85 eb 51       	mov    $0x51eb851f,%edx
  101c94:	89 c8                	mov    %ecx,%eax
  101c96:	f7 e2                	mul    %edx
  101c98:	89 d0                	mov    %edx,%eax
  101c9a:	c1 e8 05             	shr    $0x5,%eax
  101c9d:	6b c0 64             	imul   $0x64,%eax,%eax
  101ca0:	29 c1                	sub    %eax,%ecx
  101ca2:	89 c8                	mov    %ecx,%eax
  101ca4:	85 c0                	test   %eax,%eax
  101ca6:	75 0a                	jne    101cb2 <trap_dispatch+0x79>
	print_ticks();
  101ca8:	e8 36 fb ff ff       	call   1017e3 <print_ticks>
         ...
         */
        break;
  101cad:	e9 a6 00 00 00       	jmp    101d58 <trap_dispatch+0x11f>
  101cb2:	e9 a1 00 00 00       	jmp    101d58 <trap_dispatch+0x11f>
    case IRQ_OFFSET + IRQ_COM1:
        c = cons_getc();
  101cb7:	e8 fe f8 ff ff       	call   1015ba <cons_getc>
  ...
  101cd6:	e8 37 e6 ff ff       	call   100312 <cprintf>
        break;
  101cdb:	eb 7b                	jmp    101d58 <trap_dispatch+0x11f>
    case IRQ_OFFSET + IRQ_KBD:
        c = cons_getc();
  101cdd:	e8 d8 f8 ff ff       	call   1015ba <cons_getc>
  ...
  101cfc:	e8 11 e6 ff ff       	call   100312 <cprintf>
        break;
  101d01:	eb 55                	jmp    101d58 <trap_dispatch+0x11f>
  ...
  101d0a:	00 
  101d0b:	c7 44 24 04 ae 00 00 	movl   $0xae,0x4(%esp)
  101d12:	00 
  101d13:	c7 04 24 c5 39 10 00 	movl   $0x1039c5,(%esp)
  101d1a:	e8 7d ef ff ff       	call   100c9c <__panic>
  ...
  101d2e:	75 28                	jne    101d58 <trap_dispatch+0x11f>
            print_trapframe(tf);
  101d30:	8b 45 08             	mov    0x8(%ebp),%eax
  101d33:	89 04 24             	mov    %eax,(%esp)
  101d36:	e8 82 fc ff ff       	call   1019bd <print_trapframe>
            panic("unexpected trap in kernel.\n");
  101d3b:	c7 44 24 08 d6 39 10 	movl   $0x1039d6,0x8(%esp)
  101d42:	00 
  101d43:	c7 44 24 04 b8 00 00 	movl   $0xb8,0x4(%esp)
  101d4a:	00 
  101d4b:	c7 04 24 c5 39 10 00 	movl   $0x1039c5,(%esp)
  101d52:	e8 45 ef ff ff       	call   100c9c <__panic>
        panic("T_SWITCH_** ??\n");
        break;
...
trap(struct trapframe *tf) {
  ...
  101d66:	e8 ce fe ff ff       	call   101c39 <trap_dispatch>
}
  101d6b:	c9                   	leave  
  101d6c:	c3                   	ret    
...
gdt_init(void) {
  ...
  10283a:	b8 20 f9 10 00       	mov    $0x10f920,%eax
  10283f:	05 00 04 00 00       	add    $0x400,%eax
  102844:	a3 a4 f8 10 00       	mov    %eax,0x10f8a4
    ts.ts_ss0 = KERNEL_DS;
  102849:	66 c7 05 a8 f8 10 00 	movw   $0x10,0x10f8a8
  102850:	10 00 
  ...
  102866:	b8 a0 f8 10 00       	mov    $0x10f8a0,%eax
